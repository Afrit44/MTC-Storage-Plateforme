 ...
 * @author mimou
 */
public class PiecesUsures extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Stock Piéces d'usure");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PiecesUsures.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PiecesUsures().setVisible(true);
            }
        });
    }
